// Entity type protocol IDs for each supported version.
//
// Each entry is the entity type name at the corresponding index (protocol_id).
// Regenerate with: void-data/scripts/gen_entity_types.sh <version> <paper-jar-url>

pub(crate) static ENTITY_TYPE_IDS_26_1_2: &[&str] = &[
